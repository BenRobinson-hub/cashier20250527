            ...
            <div class="acea-row row-between row-bottom cart-left">
              <div class="left-top">
                ...
                <div class="btn-group-vertical">
                  ...
                  <Button :disabled="!userInfo.uid || !cartList.length" :class="{ selected: integral }" @click="integralTap">积分</Button>
                  <Button :disabled="!userInfo.uid || !cartList.length" @click="couponTap">优惠券</Button>
        ...
        <div class="acea-row" style="flex-wrap: nowrap;height: 100%;">
          <div class="goodsCon">
            <div class="goods-top">
              ...
              <swiper v-if="activityTypeArr.length" :options="swiperOption" @ready="readySwiper" @click="clickSwiper">
                <swiper-slide v-for="(item, index) in activityTypeArr" :key="index" :class="{ active: swiperClickedIndex === index }">{{ item.desc }}</swiper-slide>
              </swiper>
              <Alert v-if="swiperClickedIndex">
                <div>活动时间：{{activityTypeArr[swiperClickedIndex].section_time[0]}} ~ {{activityTypeArr[swiperClickedIndex].section_time[1]}}</div>
              ...
              <div ref="listWrap" class="list-wrap" @scroll="pageChange">
                <Row v-if="goodData.length && (goodFrom.cate_id !== '99999' || activityFrom.type)" :gutter="15" class="list">
                  <Col v-for="(item, index) in goodData" :key="index" :sm="12" :md="12" :lg="12" :xl="8" :xxl="4">
          ...
          <div class="goodClass acea-row row-center" style="flex-wrap: nowrap;">
...
import { activityList, activityTypeList } from "@/api/product";
