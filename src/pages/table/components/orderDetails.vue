<template>
  <div class="detail">
    <div class="section">
      ...
      <ul v-if="orderDatalist.userInfo" class="list">
        <li class="item">
          <div>用户昵称：</div>
          <div class="value">
            {{
        ...
        <li class="item">
          <div>绑定电话：</div>
          <div class="value">{{ orderDatalist.userInfo.phone || '暂无' }}</div>
        </li>
      </ul>
    </div>
    <div class="section">
      <div class="title">订单信息</div>
      <ul v-if="orderDatalist.orderInfo" class="list">
        <li class="item">
          <div>订单编号：</div>
          <div class="value">{{ orderDatalist.orderInfo.order_id }}</div>
        </li>
        <li class="item">
          <div>创建时间：</div>
    ...
    <div
      class="section"
      v-if="orderDatalist.orderInfo && orderDatalist.orderInfo.promotions_detail.length"
    >
    ...
    <div v-if="orderDatalist.orderInfo && orderDatalist.orderInfo.custom_form.length" class="section">
    ...
    <div class="section" v-if="orderDatalist.orderInfo && orderDatalist.orderInfo.mark">
    ...
    <div class="section" v-if="orderDatalist.orderInfo && orderDatalist.orderInfo.remark">
    ...
    <div
      class="section"
      v-if="orderDatalist.orderInfo && orderDatalist.orderInfo.delivery_type === 'express'"
    >
    ...
    <div
      class="section"
      v-if="orderDatalist.orderInfo && orderDatalist.orderInfo.delivery_type === 'send'"
    >
